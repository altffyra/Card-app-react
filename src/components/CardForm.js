...
function CardForm(props) {
 ...
 function updateFormValid(event){
  ...
  return (
    ...
    <input id='cardnumberElem'  onChange={updateFormCardnumber} type="text" maxLength="16"></input>
    <p className='small'>CARDHOLDER NAME</p>
    <input onKeyUp={updateFormName} type="text" maxLength="19" minLength="5"></input>
    ...
    <button className='AddNewCardConfirm' onClick={applyCard}> ADD CARD</button>
    </form>
  )
}
